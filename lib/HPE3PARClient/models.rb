...
module HPE3PARClient
  class VirtualVolume
    ...
    # [type - Number]
    # Detailed state of the VV - HPE3PARClient::VolumeDetailedState
    ...
    # [type - Number]
    # Indicates the copy type of the volume. - HPE3PARClient::VolumeCopyType
    ...
    # [type - Number]
    # Volume detailed state. - HPE3PARClient::VolumeDetailedState
    ...
    # [type - Number]
    # Volume compression state - HPE3PARClient::VolumeCompressionState
    attr_accessor :compression_state

    # [type - Number]
    # Volume deduplication state. - HPE3PARClient::VolumeDetailedState
    ...
    # [type - Number]
    # Volume provisioning. - HPE3PARClient::VolumeProvisioningType
    ...
    # volume size. - HPE3PARClient::VolumeDetailedState
    attr_accessor :ss_spc_alloc_warning_pct

    # [type - Number]
    # State of the volume. - HPE3PARClient::CPGState
    attr_accessor :state
  ...
  class CPG
    ...
    def initialize(object_hash)
      ...
      !object_hash['UsrUsage'] ? self.usr_usage = Usage.new(object_hash['UsrUsage']) : self.usr_usage = nil

      !object_hash['SAUsage'] ? self.sausage = Usage.new(object_hash['SAUsage']) : self.sausage = nil

      !object_hash['SDUsage'] ? self.sdusage = Usage.new(object_hash['SDUsage']) : self.sdusage = nil

      !object_hash['SAGrowth'] ? self.sagrowth = GrowthParams.new(object_hash['SAGrowth']) : self.sagrowth = nil

      !object_hash['SDGrowth'] ? self.sdgrowth = GrowthParams.new(object_hash['SDGrowth']) : self.sdgrowth = nil
      ...
      !object_hash['privateSpaceMiB'] ? self.private_space_MiB = PrivateSpace.new(object_hash['privateSpaceMiB']) : self.private_space_MiB = nil
  ...
  class VolumeSet
    ...
    # only. - HPE3PARClient::FlashCachePolicy
  ...
  class Policy
    ...
    # [type - Number]
    # Type of host based DIF policy. - HPE3PARClient::VolumeHostDIF
